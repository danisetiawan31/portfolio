...
This project is indexed by GitNexus as **portfolio** (635 symbols, 1445 relationships, 47 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
