...
This project is indexed by GitNexus as **portfolio** (883 symbols, 2081 relationships, 61 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
