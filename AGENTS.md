...
This project is indexed by GitNexus as **portfolio** (667 symbols, 1482 relationships, 49 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
